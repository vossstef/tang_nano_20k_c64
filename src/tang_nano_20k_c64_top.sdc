...
create_generated_clock -name clk64 -source [get_nets {clk_pixel_x10}] -master_clock clk_pixel_x10 -divide_by 5 [get_nets {clk64}]
create_generated_clock -name clk32 -source [get_nets {clk64}] -master_clock clk64 -divide_by 2 [get_nets {clk32}]
create_generated_clock -name clk_pixel_x5 -source [get_nets {clk_pixel_x10}] -master_clock clk_pixel_x10 -divide_by 2 [get_nets {clk_pixel_x5}]
create_generated_clock -name clk32_hid -source [get_nets {clk64}] -master_clock clk64 -divide_by 2 [get_nets {clk32_hid}]
